...
if [[ "$#" -le 1 ]] ; then
	args="-p b2lkPXJvb21uYW1lJmNhbl9lZGl0PTEmdXNlcm5hbWU9dXNlcm5hbWUmbmFtZT1QcmV6aStNb25pdG9yJnV0Yz0xMzE3NjkzMzk5LjAxJnJvb21fZW1wdHk9MQ -s pYlX7CA+nNLNr3kvD9ksimoewXc=";
else
	args="$@"
fi 
echo "Running failed login test, bad policy" $UNION_TEST_PATH/LoginTest $args
./LoginSuccess $args
(
