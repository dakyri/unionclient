...
//  and does a login and an immediate disconnection afterwards.
//
...
int main(int argc, char **argv) {
	...
	CBStatusMessageRef disconnectedListenerHandle = unionClient.AddEventListener(Event::DISCONNECTED, [&ready,&disconnected](EventType t, std::string a, UPCStatus s) {
	...
	CBClientInfoRef roomJoinedCB = unionClient.Self()->NotifyClientInfo::AddEventListener(Event::JOIN_ROOM,
		[&meetingRoom,&loginAttempt,&loginSucceed](EventType e, ClientID clientID, ClientRef cr, int, RoomID roomID, RoomRef  rr, UPCStatus s) {
